...
CREATE TABLE IF NOT EXISTS `best_requirements` (`ql` INT, `item_id` INT, `item_ref` INT, `reqs` varchar(255));

INSERT INTO `best_items` (`id`, `name`, `reqs`) VALUES (1, 'css', 'agility;sense');
INSERT INTO `best_items` (`id`, `name`, `reqs`) VALUES (2, 'cc', 'agility;strength');
INSERT INTO `best_items` (`id`, `name`, `reqs`) VALUES (3, 'cm', 'stamina;strength');
